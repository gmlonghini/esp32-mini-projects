...
lv_obj_t * humidityicon_create(lv_obj_t * parent)
{
    ...
    if (demo_lvgl_ambiental_check_target(DEMO_LVGL_AMBIENTAL_TARGET_ALL)) {
        ...
        lv_obj_set_name_static(image_0, "humidityicon_#");
        lv_obj_set_width(image_0, 63);
        lv_obj_set_height(image_0, 63);
        lv_image_set_src(image_0, image_humidityicon);
